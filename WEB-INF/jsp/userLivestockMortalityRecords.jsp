					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">ADD MORTALITY RECORDS</div>
								<div class="panel-body">
									<form id="" action="userSaveLivestockMortalityRecords" method="POST"
										...
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="causeOfDeath" class="form-control"
														placeholder="Cause of death" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="intervations" class="form-control"
														placeholder="Interventions made before death" id="one"
														type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="dispose" class="form-control"
														placeholder="Method of dispose of the carcass" id="one"
														type="text" />
												</div>

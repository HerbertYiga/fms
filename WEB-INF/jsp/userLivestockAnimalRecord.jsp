	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewLivestockAnimalRecord"> <i
						class="fa fa-eye"></i> View Animal Records
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">ADD ANIMAL RECORD</div>
								<div class="panel-body">
							<form id="" action="userSaveLivestockAnimalRecords" method="POST"
									...
									<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="animalName" class="form-control"
													placeholder="Animal's Name" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="animalBreed" class="form-control"
													placeholder="Breed" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="identificationNo" class="form-control"
													placeholder="Identification Number" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="birthDate" class="form-control"
													placeholder="Birth Date" id="one" type="date" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="dateAnimalRecieved" class="form-control"
													placeholder="Expected Crop Yield" id="one" type="date" />
											</div>

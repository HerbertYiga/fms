									...
									<table class="table table-striped table-hover table-bordered">
										...
										<tbody>
											...
											<c:forEach var="details" items="${list}">
												<tr>
													<td>${details.animalName}</td>

													<td>${details.animalBreed}</td>
													<td>${details.identificationNo}</td>
													<td>${details.birthDate}</td>
													<td>${details.dateAnimalRecieved}</td>

		...
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewMachineryRecords"> <i
						class="fa fa-eye"></i> View Machinery Records
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">MACHINERY RECORDS</div>
										...
										<tbody>
											...
											<c:forEach var="details" items="${list}">
												<tr>
													...
													<td><a href="#" class="btn btn-default">All
															Details</a></td>

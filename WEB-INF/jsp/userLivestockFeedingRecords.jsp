		...
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewCropRecords"> <i
						class="fa fa-eye"></i> Feeding Records
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">ADD FEEDING RECORDS</div>
								<div class="panel-body">
								<form id="" action="userViewLivestockFeedingRecords" method="POST"
									...
									<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="date" class="form-control"
													placeholder="Date of feeding" type="date" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="description" class="form-control"
													placeholder="Description" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="weight" class="form-control"
													placeholder="Weight" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="numberOfAnimalsFed" class="form-control"
													placeholder="Number of animals feed" id="one" type="text" />
											</div>

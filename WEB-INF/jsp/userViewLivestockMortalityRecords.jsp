	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewLivestockMortalityRecords"> <i
						class="fa fa-eye"></i> View Mortality Records
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">MORTALITY RECORDS</div>
									...
									<table class="table table-striped table-hover table-bordered">
										<thead>
											<tr>
												...
												<th>Interventions</th>
												<th>Method of dispose of the carcass</th>
										...
										<tbody>
											...
											<c:forEach var="details" items="${list}">
												<tr>
													...
													<td></td>
													<td>${details.causeOfDeath}</td>
													<td>${details.intervations}</td>
													<td>${details. dispose}</td>

					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">IRRIGATION RECORDS</div>
									...
									<table class="table table-striped table-hover table-bordered">
										...
										<tbody>
											...
											<c:forEach var="details" items="${list}">
												<tr>
													<td>${details.crop}</td>
													<td>${details.irrigationdate}</td>
													<td>${details.landCoverage}</td>
													...
													<td><a href="#" class="btn btn-default">All Details</a></td>

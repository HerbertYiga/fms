	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewLivestockFlockRecords"> <i
						class="fa fa-eye"></i> View flock Number Records
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">ADD FLOCK NUMBER RECORDS</div>
								<div class="panel-body">
								<form id="" action="userSaveLivestockFlockRecords" method="POST"
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="typeOfAnimals" class="form-control"
													placeholder="Type of animals" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="noda" class="form-control"
													placeholder="Number Of dead animals" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="nora" class="form-control"
													placeholder="Number of removed animals" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											<label class="col-lg-1 control-label" for="otherName"></label>
											<div class="col-lg-8">
												<input name="noaah" class="form-control"
													placeholder="Number of animals added to the heard" type="text" />
											</div>

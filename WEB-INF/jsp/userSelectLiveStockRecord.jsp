					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">SELECT RECORD</div>
								<div class="panel-body">
									
									<form  action="userCheckLiveStockRecord">
										<div class="col-lg-10">
											...
											<select name="recordType" class="form-control" onchange="this.form.submit()">
												...
												<option value="livestockanimalrecord">ANIMAL RECORDS</option>
												<option value="livestockflockrecord">FLOCK NUMBER RECORDS</option>
												<option value="livestockbreedingrecord">BREEDING RECORDS</option>
												<option value="livestockcalfrecord">CALF RECORDS</option>
												<option value="livestockfeedingRecords">FEEDING RECORDS</option>
												<option value="livestockhealthRecords">HEALTH RECORDS</option>
												<option value="livestockmortalityRecords">MORTALITY RECORDS</option>
												<option value="livestockmilkproductionRecords">MILK PRODUCTION RECORDS</option>
												<option value="livestockmilksaleRecords">MILK SALE RECORDS</option>
												<option value="livestockanimalsaleRecords">ANIMAL SALE RECORDS</option>
												<option value="livestockpermitRecords">ANIMAL EXITING RECORDS</option>

	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewLivestockPermitRecords"> <i
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">PERMIT RECORDS</div>
										...
										<tbody>
											...
											<c:forEach var="details" items="${list}">
												<tr>
													...
													<td></td>
													<td>${details.animalAge}</td>
													<td>${details.animalWeight}</td>
													<td>${details.releasedByName}</td>
												<td>${details.releasedByContact}</td>
												<td>${details.takenByName}</td>
												<td>${details.takenByContact}</td>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="panel panel-primary">
							<div class="panel-heading">
								<h4>
									<b>VIEW PERMIT DETAILS RECORDS</b>
								</h4>
							</div>

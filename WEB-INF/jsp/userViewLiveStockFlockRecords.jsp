		...
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewLivestockFlockRecords"> <i
						class="fa fa-eye"></i> View Flock records
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">FLOCK RECORDS</div>
									...
									<table class="table table-striped table-hover table-bordered">
										<thead>
											<tr>
												...
												<th>Dead animals</th>
												<th>Animals removed/culled</th>
												<th>Reason</th>
												<th>Animals added to the heard</th>

		...
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewLivestockCalfRecords"> <i
						class="fa fa-eye"></i> Calf Records
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">ADD CALF RECORDS</div>
								<div class="panel-body">
									<form id="" action="userSaveLivestockCalfRecords" method="POST"
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="calfName" class="form-control"
														placeholder="Calf's Name" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="dob" class="form-control"
														placeholder="Date of Birth" id="one" type="date" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="breedOfCalf" class="form-control"
														placeholder="Breed of calf" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="mnab" class="form-control"
														placeholder="Mother's Name/Number & Breed" id="one"
														type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="fnab" class="form-control"
														placeholder="Father's Name/Number & Breed" id="one"
														type="text" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label" for="otherName"></label>
												<div class="col-lg-8">
													<input name="weightAtBirth" class="form-control"
														placeholder="Weight at Birth" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													...
													<select name="sexOfCalf" class="form-control"
														>
														<option value="" disabled selected>Calf's sex</option>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label" for="otherName"></label>
												<div class="col-lg-8">
													<input name="conditionAtBirth" class="form-control"
														placeholder="Condition of calf" type="text" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label" for="otherName"></label>
												<div class="col-lg-8">
													<input name="dateOfWeaning" class="form-control"
														placeholder="Date Of weaning" type="date" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label" for="otherName"></label>
												<div class="col-lg-8">
													<input name="weightAtWeaning" class="form-control"
														placeholder="Weight at weaning" type="text" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label" for="otherName"></label>
												<div class="col-lg-8">
													<input name="weightAtThreeMonths" class="form-control"
														placeholder="Weight at three months" type="text" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label" for="otherName"></label>
												<div class="col-lg-8">
													<input name="weightAtFiveMonths" class="form-control"
														placeholder="Weight at five months" type="text" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label" for="otherName"></label>
												<div class="col-lg-8">
													<input name="weightAtSevenMonths" class="form-control"
														placeholder="Weight at seven months" type="text" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label" for="otherName"></label>
												<div class="col-lg-8">
													<input name="weightAtNineMonths" class="form-control"
														placeholder="Weight at nine months" type="text" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label" for="otherName"></label>
												<div class="col-lg-8">
													<input name="weightAtTwelveMonths" class="form-control"
														placeholder="Weight at twelve months" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="ageAtFirstService" class="form-control"
														placeholder="Age at first service" type="text" />
												</div>

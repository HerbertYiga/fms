				...
				<li class="sub open"><a href="javascript:;"> <i
					...
					<ul class="templatemo-submenu">
						<li><a href="javascript:;" data-toggle="modal"
							data-target="#userModal" style="color:#EA149C"><i class="fa fa-eye"></i> Crop Records</a></li>

						<li><a href="adminViewUser" class="fa fa-eye" style="color:maroon"> Live Stock Records</a></li>


						<li><a href="adminViewUser" class="fa fa-eye" style="color:green"> Poultry Records</a></li>
									...
									<form  action="userCheckRecordType">
										<div class="col-lg-10">
											...
											<select name="recordType" class="form-control" onchange="this.form.submit()">
												...
												<option value="croprecord">CROP</option>
												<option value="MACHINERY AND EQUIPMENT USE RECORD">LIVE STOCK</option>
												<option value="LABOR RECORD">POULTRY</option>

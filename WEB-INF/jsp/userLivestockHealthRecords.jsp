	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewLivestockHealthRecords"> <i
						class="fa fa-eye"></i>Stock Health Records
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">ADD HEALTH RECORDS</div>
								<div class="panel-body">
									<form id="" action="userSaveLivestockHealthRecords" method="POST"
										...
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="diseases" class="form-control"
														placeholder="Diseases" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="symptom" class="form-control"
														placeholder="Symptom" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="treatment" class="form-control"
														placeholder="Treatment" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="obs" class="form-control"
														placeholder="Observation" type="text" />
												</div>

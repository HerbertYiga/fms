	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewHarvestRecords"> <i
						class="fa fa-eye"></i> Harvest Records
		...
		<div class="templatemo-content-wrapper">
			<div class="templatemo-content">
				...
				<h4 style="color: orange">
					<b>HARVEST/PRODUCTION RECORDS</b>
				</h4>
						...
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									<form id="" action="userAddHarvestRecord" method="POST"
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="doh" class="form-control" placeholder="Date"
														id="one" type="date" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="qH" class="form-control"
														placeholder="Quantity Harvested" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="qC" class="form-control"
														placeholder="Quantity Consumed" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="qocadt" class="form-control"
														placeholder="Quantity of crop After Drying & Threshing"
														id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="qmp" class="form-control"
														placeholder="Quantity Milled/ Processed" type="text" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label" for="otherName"></label>
												<div class="col-lg-8">
													<input name="qps" class="form-control"
														placeholder="Quantity Packaged & Stored (Kg/Bags)" type="text" />
												</div>
												...
												<label class="col-lg-1 control-label" for="otherName"></label>
												<div class="col-lg-8">
													<input name="qoub" class="form-control"
														placeholder="Quantity of Usable Bi-Products" type="text" />
												</div>
											...
											<div class="form-group">
												<label class="col-lg-1 control-label" for="otherName"></label>
												<div class="col-lg-8">
													<input name="harvestComment" class="form-control"

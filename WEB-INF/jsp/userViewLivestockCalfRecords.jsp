		...
		<div class="templatemo-content-wrapper">
			<div class="templatemo-content">
				...
				<h4 style="color: orange">
					<b>VIEW LIVE STOCK CALF RECORDS</b>
				</h4>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">CALF RECORDS</div>
									...
									<table class="table table-striped table-hover table-bordered">
										<thead>
											<tr>
												...
												<th>Date of birth</th>
												<th>Breed</th>
												<th>Father's Name/No</th>
												<th>Mother's Name/No</th>
										...
										<tbody>
											...
											<c:forEach var="details" items="${list}">
												<tr>
													<td>${details.calfName}</td>
													<td>${details.dob}</td>
													<td>${details.breedOfCalf}</td>
													<td>${details.fnab }</td>

													<td>${details.mnab}</td>
													<td><a>View All Details</a></td>

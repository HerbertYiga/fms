		...
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="javascript:;"> <i
						class="fa fa-database"></i> Crop Sales Records
						...
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
											<form id="" action="userAddSalesRecord" method="POST"
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="crop" class="form-control"
														placeholder="Crop To Be Sold" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="dos" class="form-control" placeholder=""
														id="one" type="date" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="quantitySold" class="form-control"
														placeholder="Quantity To Be Sold" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="tvocs" class="form-control"
														placeholder="Total value of crops sold" id="one"
														type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="saleComment" class="form-control"

						...
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									...
									<form  action="userCheckCropRecord">
										<div class="col-lg-10">
											...
											<select name="recordType" class="form-control" onchange="this.form.submit()">
												...
												<option value="croprecord">CROPPING RECORDS</option>
												<option value="irrigationrecord">IRRIGATION RECORDS</option>
												<option value="chemicalrecord">CHEMICAL INPUT USE RECORDS</option>
												<option value="machineryrecord">MACHINERY & EQUIPMENT USE RECORDS</option>
												<option value="harvestrecord">HARVEST/PRODUCTION RECORDS</option>
												<option value="cropsalesrecord">CROP SALE RECORDS</option>

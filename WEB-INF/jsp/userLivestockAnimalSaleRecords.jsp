					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">ADD ANIMAL SALE RECORDS</div>
								<div class="panel-body">
								<form id="" action="userSaveLivestockanimalsaleRecords" method="POST"
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="weightOfAnimal" class="form-control"
													placeholder="Weight of Animal" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="ageOfAnimal" class="form-control"

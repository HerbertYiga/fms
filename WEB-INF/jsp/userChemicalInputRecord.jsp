	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewChemicalRecords"> <i
						class="fa fa-eye"></i> View Chemical Records
		...
		<div class="templatemo-content-wrapper">
			<div class="templatemo-content">
				...
				<h4 style="color: orange">
					<b>CHEMICAL INPUT USE RECORDS</b>
				</h4>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">ADD CHEMICAL RECORD</div>
								<div class="panel-body">
									<form id="" action="userAddChemicalRecord" method="POST"
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="doi" class="form-control" placeholder="Date"
														id="one" type="date" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="toe" class="form-control"
														placeholder="Type Of Enterprise" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="toa" class="form-control"
														placeholder="Type Of Agro Chemical" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="qoaa" class="form-control"
														placeholder="Quantity of Agro-chemical Applied" id="one"
														type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="toc" class="form-control"
														placeholder="Total Area Covered" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="chemicalcomment" class="form-control"

		...
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="javascript:;"> <i
						class="fa fa-database"></i> View Records
					...
					<ul class="templatemo-submenu">
						<li><a href="javascript:;" data-toggle="modal"
							data-target="#userModal" style="color: #EA149C"><i
								class="fa fa-eye"></i> Crop Records</a></li>

						<li><a href="adminViewUser" class="fa fa-eye"
							style="color: maroon"> Live Stock Records</a></li>


						<li><a href="adminViewUser" class="fa fa-eye"
							style="color: green"> Poultry Records</a></li>
						...
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								...
								<div class="panel-body">
									...
									<form action="userCheckPoultryRecord">
										<div class="col-lg-10">
											...
											<select name="recordType" class="form-control"
												...
												<option value="flockrecord">FLOCK NUMBER RECORDS</option>
												<option value="stockrecord">STOCKING RECORDS</option>
												<option value="feedsrecord">FEED RECORDS</option>
												<option value="vaccnationrecord">VACCINATION
													RECORDS</option>
												<option value="poultryhealthrecord">HEALTH RECORDS</option>
												<option value="eggproductionrecord">EGG PRODUCTION
													RECORDS</option>
												<option value="eggrading">EGG GRADING RECORDS</option>

												<option value="eggsalerecord">EGG SALE RECORDS</option>
												<option value="chikensalerecord">CHICKEN SALE
													RECORDS</option>

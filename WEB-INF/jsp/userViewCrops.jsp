		...
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="javascript:;"> <i
						class="fa fa-database"></i> All Records
					...
					<ul class="templatemo-submenu">
						<li><a href="javascript:;" data-toggle="modal"
							data-target="#userModal"><i class="fa fa-eye"></i> Crop
								Records</a></li>

						<li><a href="adminViewUser" class="fa fa-eye"> Mahinery
								and Equipment</a></li>


						<li><a href="adminViewUser" class="fa fa-eye"> Labour
								Records</a></li>

						<li><a href="adminViewUser" class="fa fa-eye"> Chemical
								Inputs</a></li>

						<li><a href="adminViewUser" class="fa fa-eye"> Harvest
								Records</a></li>

						<li><a href="adminViewUser" class="fa fa-eye"> Sales
								Records</a></li>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">Crop Records</div>
									...
									<table class="table table-striped table-hover table-bordered">
										<thead>
											<tr>
												...
												<th>Type of Crops</th>
												<th>Quantity of seeds planted</th>
												<th>Crop yield expected (Kg)</th>
												<th>Remarks</th>
												<th>Remarks</th>

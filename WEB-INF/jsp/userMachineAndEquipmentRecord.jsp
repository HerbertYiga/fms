	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewMachineryRecords"> <i
						class="fa fa-eye"></i> Machinery/Equipment 
		...
		<div class="templatemo-content-wrapper">
			<div class="templatemo-content">
				...
				<h4 style="color: orange">
					<b>MACHINERY & EQUIPMENT USE RECORDS</b>
				</h4>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">MACHINERY/EQUIPMENT USE RECORDS</div>
								<div class="panel-body">
							
									<form id="" action="userAddMachinery" method="POST"
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="doim" class="form-control" placeholder="Date"
														id="one" type="date" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="toem" class="form-control"
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="tom" class="form-control"
														placeholder="Type of machine used" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="tood" class="form-control"
														placeholder="Type of operation done" id="one"
														type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="aof" class="form-control"
														placeholder="Amount of fuel" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="machinerycomment" class="form-control"

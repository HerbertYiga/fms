					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">ADD ANIMAL EXITING   PERMIT RECORDS</div>
								<div class="panel-body">
								<form id="" action="userAddCropRecord" method="POST"
									...
									<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="crop" class="form-control"
													placeholder="Crop to be planted" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="dop" class="form-control"
													placeholder="" id="one" type="date" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="qosp" class="form-control"
													placeholder="Quantity Planted" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="top" class="form-control"
													placeholder="Total Area Planted" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="ecy" class="form-control"
													placeholder="Expected Crop Yield" id="one" type="text" />
											</div>

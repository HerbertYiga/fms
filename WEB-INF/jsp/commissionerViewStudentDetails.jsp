		...
		<div class="templatemo-content-wrapper">
			<div class="templatemo-content">
				<ol class="breadcrumb">
					...
					<li class="active">Approving student details</li>
				...
				<table class="table table-striped table-bordered table-list">
						...
						<tbody id="myTable">
								...
								<tr>
									...
									<td><img class="img-responsive" alt="a" height="50px"
										width="100px"
					...
					<form:form class='form-inline' action="commissionerGenerateVotingToken"
						commandName="confirm">
						<div class="itext-center">
							<form:input path="studentNo" class="form-control" placeholder=""
								id="one" type="hidden" value="${student.studentNo}" />

							<button class="btn btn-success btn-sm pull-right" type="submit">Generate Voting Token</button>
							</span>
						</div>
					</form:form>

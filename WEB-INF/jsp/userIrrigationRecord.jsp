	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewIrrigationRecords"> <i
						class="fa fa-eye"></i> View Irrigation Records
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								...
								<form id="" action="userAddIrrigationRecord" method="POST"
									...
									<fieldset>
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="crop" class="form-control"
													placeholder="Crop to be irrigated" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="irrigationdate" class="form-control"
													placeholder="Date of irrigation" id="one" type="date" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="toc" class="form-control"
													placeholder="Type Of Crop" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="landCoverage" class="form-control"
													placeholder="Land Covered" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="moi" class="form-control"
													placeholder="Method Of irrigation" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="sow" class="form-control"
													placeholder="Source of water" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input name="qowused" class="form-control"
													placeholder="Quantity of water used" type="text" />
											</div>
											...
											<div class="col-lg-8">
												<input name="taqopused" class="form-control"
													placeholder="Type or quantity of power used
													" type="text" />
											</div>

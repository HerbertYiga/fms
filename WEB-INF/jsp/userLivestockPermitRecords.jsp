...
<body>
	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewCropRecords"> <i
						class="fa fa-eye"></i> View Permit  Records
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">ADD LIVE STOCK PERMIT RECORDS</div>
								<div class="panel-body">
									<form id=" "  action="userSaveLivestockPermitRecords"
										...
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="animalAge" class="form-control"
														placeholder="Age of animal" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="animalWeight" class="form-control"
														placeholder="Animal weight" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="animalCondition" class="form-control"
														placeholder="Animal Condition" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="reason" class="form-control"
														placeholder="Reason" id="one" type="text" />
												</div>
	...
	<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="releasedByName" class="form-control"
														placeholder="Released By (Name)" id="one" type="text" />
												</div>
												...
												<div class="col-lg-8">
													<input name="releasedByContact" class="form-control"
														placeholder="Released By's contact" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="takenByName" class="form-control"
														placeholder="Taken By" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="takenByContact" class="form-control"
														placeholder="Contact for the person taking the animal"
														id="one" type="text" />
												</div>

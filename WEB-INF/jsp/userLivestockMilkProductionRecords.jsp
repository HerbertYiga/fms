...
<body>
	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li><a href="javascript:;" data-toggle="modal"
					data-target="#morningModal"><i class="fa fa-plus"></i>Add
						Morning Record</a></li>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">UPDATE MILK RECORDS</div>
		...
		<div class="modal fade" id="morningModal" tabindex="-1" role="dialog"
			aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<form id="" action="userSaveLivestockMilkProductionRecords" method="POST"
									...
									<fieldset>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input name="morning" class="form-control"
													placeholder="Morning Record" id="one" type="text" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input name="evening" class="form-control"
													placeholder="evening" id="one" type="hidden" value="0" />
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input name="amountGivenToCalves" class="form-control"
													placeholder="amount given to calves" id="one" type="hidden" value="0" />
											</div>
											...
											<div class="col-lg-10">
												<input name="amountGivenForSale" class="form-control"
													placeholder="amountGivenForSale" id="one" type="hidden" value="0"/>
											</div>
											...
											<div class="col-lg-10">
												<input name="comments" class="form-control"
													placeholder="Comments" id="one" type="hidden"  value="null"/>
											</div>

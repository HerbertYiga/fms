					...
					<ul class="templatemo-submenu">
						<li><a href="javascript:;" data-toggle="modal"
							...
							data-target="#uploadCandidatesModel"><i class="fa fa-plus"></i>
								...
								<li><a href="javascript:;" data-toggle="modal"
							data-target="#uploadCandidatesImageModel"><i class="fa fa-plus"></i>
								 Upload
								images for candidates </a></li>
								


						<li><a href="adminViewUser" class="fa fa-upload"> View Registered Candidates</a></li>
		...
		<div class="templatemo-content-wrapper">
			<div class="templatemo-content">
				<ol class="breadcrumb">
					...
					<li><a href="#">Voter's register</a></li>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="table-responsive">
										<h1 class="margin-bottom-15">Registred Candidates  </h1>

	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="sub open"><a href="userViewLivestockMilkSaleRecords">
						<i class="fa fa-eye"></i>View Milk Sale Records
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 margin-bottom-30">
							<div class="panel panel-primary">
								<div class="panel-heading">ADD MILK SALE RECORDS</div>
								<div class="panel-body">
									<form id="" action="userSaveLivestockMilkSaleRecords"
										...
										<fieldset>
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="date" class="form-control"
														placeholder="Date of selling milk" type="date" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="qoms" class="form-control"
														placeholder="Quantity of milk sold" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="unitprice" class="form-control"
														placeholder="Unit price" id="one" type="text" />
												</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-8">
													<input name="comments" class="form-control"
														placeholder="Comments" id="one" type="text" />
												</div>
